...
public class NewOrder extends JFrame {
    ...
    public NewOrder(String access_level, Dashboard dashboard, int employee_ID) {
        ...
        newOrderFrame.setIconImage(icon.getImage());
        ...
        WindowAdapter windowAdapter = new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                if (choice == JOptionPane.YES_OPTION) {
                    ...
                    ops.cancelCurrentTransaction(currenttransactionID);    
        ...
        button3.getModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ButtonModel model = (ButtonModel) e.getSource();
                if (model.isPressed()) {
                    button3.setBackground(Color.decode(buttonColor)); // Change color when pressed
                    System.out.println("Confirm Transaction - Is Pressed");
                } else {
        ...
        button4.getModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (model.isPressed()) {
                    ...
                    System.out.println("Edit Item - Is Pressed");
                } else {
        ...
        button5.getModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (model.isPressed()) {
                    ...
                    System.out.println("Order List - Is Pressed");
                } else {
        ...
        searchProductButton.setBackground(Color.decode(buttonColor));
        searchProductButton.setForeground(Color.decode(fontColor));
        ...
        searchProductButton.getModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ButtonModel model = (ButtonModel) e.getSource();
                if (model.isPressed()) {
                    searchProductButton.setBackground(Color.decode(buttonColorOff)); // Change color when pressed
                    System.out.println("Product List - Is Pressed");
                } else {
                    searchProductButton.setBackground(Color.decode(buttonColor)); // Change color back when released
                }
            }
        });
        ...
        addButton.setForeground(Color.decode(fontColor));
        ...
        addButton.getModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ButtonModel model = (ButtonModel) e.getSource();
                if (model.isPressed()) {
                    addButton.setBackground(Color.decode(buttonColorOff)); // Change color when pressed
                    System.out.println("Add Button - Is Pressed");
                } else {
                    addButton.setBackground(Color.decode(buttonColor)); // Change color back when released
                }
            }
        });
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (!ops.doesProductExist(productID)) {
        ...
        checkButton.setBackground(Color.decode(buttonColor));
        checkButton.setForeground(Color.decode(fontColor));
        ...
        checkButton.getModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ButtonModel model = (ButtonModel) e.getSource();
                if (model.isPressed()) {
                    checkButton.setBackground(Color.decode(buttonColorOff)); // Change color when pressed
                    System.out.println("Check Button - Is Pressed");
                } else {
                    checkButton.setBackground(Color.decode(buttonColor)); // Change color back when released
                }
            }
        });
